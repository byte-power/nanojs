...
func Opts() *testopts {
	return &testopts{
		modules:     nanojs.NewModuleMap(),
		symbols:     make(map[string]nanojs.Object),
		maxAllocs:   -1,
		skip2ndPass: false,
	}
}
...
func (o *testopts) Symbol(name string, value nanojs.Object) *testopts {
	c := o.copy()
...
func TestUndefined(t *testing.T) {
	expectRun(t, `out = undefined`, nil, nanojs.UndefinedValue)
	expectRun(t, `out = undefined.a`, nil, nanojs.UndefinedValue)
	expectRun(t, `out = undefined[1]`, nil, nanojs.UndefinedValue)
	expectRun(t, `out = undefined.a.b`, nil, nanojs.UndefinedValue)
	expectRun(t, `out = undefined[1][2]`, nil, nanojs.UndefinedValue)
...
func TestBuiltinFunction(t *testing.T) {
	...
	expectRun(t, `out = int([1])`, nil, nanojs.UndefinedValue)
	expectRun(t, `out = int({a: 1})`, nil, nanojs.UndefinedValue)
	expectRun(t, `out = int(undefined)`, nil, nanojs.UndefinedValue)
	...
	expectRun(t, `out = int(undefined, undefined)`, nil, nanojs.UndefinedValue)
	...
	expectRun(t, `out = string(undefined)`, nil, nanojs.UndefinedValue) // not "undefined"
	...
	expectRun(t, `out = float(true)`, nil, nanojs.UndefinedValue)
	expectRun(t, `out = float(false)`, nil, nanojs.UndefinedValue)
	expectRun(t, `out = float('8')`, nil, nanojs.UndefinedValue)
	expectRun(t, `out = float([1,8.1,true,3])`, nil, nanojs.UndefinedValue)
	expectRun(t, `out = float({a: 1, b: "foo"})`, nil, nanojs.UndefinedValue)
	expectRun(t, `out = float(undefined)`, nil, nanojs.UndefinedValue)
	...
	expectRun(t, `out = float(undefined, undefined)`, nil, nanojs.UndefinedValue)

	expectRun(t, `out = char(56)`, nil, '8')
	expectRun(t, `out = char(1.8)`, nil, nanojs.UndefinedValue)
	expectRun(t, `out = char("-52.2")`, nil, nanojs.UndefinedValue)
	expectRun(t, `out = char(true)`, nil, nanojs.UndefinedValue)
	expectRun(t, `out = char(false)`, nil, nanojs.UndefinedValue)
	expectRun(t, `out = char('8')`, nil, '8')
	expectRun(t, `out = char([1,8.1,true,3])`, nil, nanojs.UndefinedValue)
	expectRun(t, `out = char({a: 1, b: "foo"})`, nil, nanojs.UndefinedValue)
	expectRun(t, `out = char(undefined)`, nil, nanojs.UndefinedValue)
	...
	expectRun(t, `out = char(undefined, undefined)`, nil, nanojs.UndefinedValue)
	...
	expectRun(t, `out = bytes(1.8)`, nil, nanojs.UndefinedValue)
	expectRun(t, `out = bytes("-522")`, nil, []byte{'-', '5', '2', '2'})
	expectRun(t, `out = bytes(true)`, nil, nanojs.UndefinedValue)
	expectRun(t, `out = bytes(false)`, nil, nanojs.UndefinedValue)
	expectRun(t, `out = bytes('8')`, nil, nanojs.UndefinedValue)
	expectRun(t, `out = bytes([1])`, nil, nanojs.UndefinedValue)
	expectRun(t, `out = bytes({a: 1})`, nil, nanojs.UndefinedValue)
	expectRun(t, `out = bytes(undefined)`, nil, nanojs.UndefinedValue)
	...
	expectRun(t, `out = bytes(undefined, undefined)`, nil, nanojs.UndefinedValue)
	...
	nanojs.MaxStringLen = 9
	expectError(t, `format("%s", "1234567890")`,
		nil, "exceeding string size limit")
	nanojs.MaxStringLen = 2147483647

	// delete
	expectError(t, `delete()`, nil, nanojs.ErrWrongNumArguments.Error())
	expectError(t, `delete(1)`, nil, nanojs.ErrWrongNumArguments.Error())
	expectError(t, `delete(1, 2, 3)`, nil, nanojs.ErrWrongNumArguments.Error())
	expectError(t, `delete({}, "", 3)`, nil, nanojs.ErrWrongNumArguments.Error())
	...
	expectRun(t, `out = delete({}, "")`, nil, nanojs.UndefinedValue)
	...
	// splice
	expectError(t, `splice()`, nil, nanojs.ErrWrongNumArguments.Error())
	...
	expectError(t, `splice([], 0, immutable({}))`, nil,
		`invalid type for argument 'third'`)
	expectError(t, `splice([], 1)`, nil, nanojs.ErrIndexOutOfBounds.Error())
	expectError(t, `splice([1, 2, 3], 0, -1)`, nil,
		nanojs.ErrIndexOutOfBounds.Error())
...
func TestBytesN(t *testing.T) {
	curMaxBytesLen := nanojs.MaxBytesLen
	defer func() { nanojs.MaxBytesLen = curMaxBytesLen }()
	nanojs.MaxBytesLen = 10
...
func TestBytes(t *testing.T) {
	...
	expectRun(t, `out = bytes("abcde")[10]`, nil, nanojs.UndefinedValue)
}
...
func TestVMErrorUnwrap(t *testing.T) {
	...
	userFunc := func(err error) *nanojs.UserFunction {
		return &nanojs.UserFunction{Name: "user_func", Value: func(args ...nanojs.Object) (nanojs.Object, error) {
			return nil, err
		}}
	}
	userModule := func(err error) *nanojs.BuiltinModule {
		return &nanojs.BuiltinModule{
			Attrs: map[string]nanojs.Object{
				"afunction": &nanojs.UserFunction{
					Name: "afunction",
					Value: func(a ...nanojs.Object) (nanojs.Object, error) {
						return nil, err
					},
				},
			},
...
func TestFunction(t *testing.T) {
	...
	expectRun(t, `f := func(...x) { return x; }; out = f();`,
		nil, &nanojs.Array{Value: []nanojs.Object{}})
...
func TestIf(t *testing.T) {
	...
	expectRun(t, `if (false) { out = 10 }`, nil, nanojs.UndefinedValue)
	...
	expectRun(t, `if (1 > 2) { out = 10 }`, nil, nanojs.UndefinedValue)
...
func (o *StringDict) IndexGet(index nanojs.Object) (nanojs.Object, error) {
	...
	for k, v := range o.Value {
		if strings.EqualFold(strIdx.Value, k) {
			return &nanojs.String{Value: v}, nil
		}
	}
...
func (o *StringDict) IndexSet(index, value nanojs.Object) error {
	strIdx, ok := index.(*nanojs.String)
	if !ok {
...
func (o *StringCircle) IndexGet(index nanojs.Object) (nanojs.Object, error) {
	...
	return &nanojs.String{Value: o.Value[r]}, nil
}

func (o *StringCircle) IndexSet(index, value nanojs.Object) error {
	intIdx, ok := index.(*nanojs.Int)
	if !ok {
		return nanojs.ErrInvalidIndexType
	}
...
func TestIndexable(t *testing.T) {
	...
	expectRun(t, `out = dict["x"]`,
		Opts().Symbol("dict", dict()).Skip2ndPass(), nanojs.UndefinedValue)
	...
	expectRun(t, `out = arr["four"]`,
		Opts().Symbol("arr", strArr()).Skip2ndPass(), nanojs.UndefinedValue)
...
out = {
	...
	expectRun(t, `out = {foo: 5}["bar"]`, nil, nanojs.UndefinedValue)
	expectRun(t, `key := "foo"; out = {foo: 5}[key]`, nil, 5)
	expectRun(t, `out = {}["foo"]`, nil, nanojs.UndefinedValue)
...
func TestBuiltin(t *testing.T) {
	m := Opts().Module("math",
		&nanojs.BuiltinModule{
			Attrs: map[string]nanojs.Object{
				"abs": &nanojs.UserFunction{
					Name: "abs",
					Value: func(a ...nanojs.Object) (nanojs.Object, error) {
						v, _ := nanojs.ToFloat64(a[0])
						return &nanojs.Float{Value: math.Abs(v)}, nil
					},
				},
			},
		})
...
`), "Runtime Error: not callable: int\n\tat mod1:3:4\n\tat test:4:1")
	...
	expectRun(t, `out = import("mod0")`,
		Opts().Module("mod0", ``), nanojs.UndefinedValue)
	expectRun(t, `out = import("mod0")`,
		...
		&nanojs.BuiltinModule{
			Attrs: map[string]nanojs.Object{
				"intn": &nanojs.UserFunction{
					Name: "abs",
					Value: func(a ...nanojs.Object) (nanojs.Object, error) {
						v, _ := nanojs.ToInt64(a[0])
						return &nanojs.Int{Value: rand.Int63n(v)}, nil
					},
				},
			},
		})
...
func testAllocsLimit(t *testing.T, src string, limit int64) {
	expectRun(t, src,
		Opts().Skip2ndPass(), nanojs.UndefinedValue) // no limit
	expectRun(t, src,
		Opts().MaxAllocs(limit).Skip2ndPass(), nanojs.UndefinedValue)
	expectRun(t, src,
		Opts().MaxAllocs(limit+1).Skip2ndPass(), nanojs.UndefinedValue)
	if limit > 1 {
		expectError(t, src,
...
b := a.x.c`, nil, nanojs.UndefinedValue)
...
b := a.x.y`, nil, nanojs.UndefinedValue)
...
func TestSourceModules(t *testing.T) {
	...
	testEnumModule(t, `out = enum.all(0, enum.value)`,
		nanojs.UndefinedValue) // non-enumerable: undefined
	...
	testEnumModule(t, `out = enum.at(["one","two","three"], 3)`,
		nanojs.UndefinedValue)
	testEnumModule(t, `out = enum.at(["one","two","three"], "1")`,
		nanojs.UndefinedValue) // non-int index: undefined
	...
	testEnumModule(t, `out = enum.at({a:"one",b:"two",c:"three"}, "d")`,
		nanojs.UndefinedValue)
	testEnumModule(t, `out = enum.at({a:"one",b:"two",c:"three"}, 'a')`,
		nanojs.UndefinedValue) // non-string index: undefined
	...
	testEnumModule(t, `out = enum.filter([false,1,0,2], enum.value)`,
		ARR{1, 2})
	testEnumModule(t, `out = enum.filter({}, enum.value)`,
		nanojs.UndefinedValue) // non-array: undefined
...
func expectRun(
	...
	if !opts.skip2ndPass {
		...
		case *nanojs.Array:
			expectedObj = &nanojs.ImmutableArray{Value: eo.Value}
		case *nanojs.Map:
			expectedObj = &nanojs.ImmutableMap{Value: eo.Value}
		}
...
func traceCompileRun(
	...
	modules *nanojs.ModuleMap,
	maxAllocs int64,
) (res map[string]nanojs.Object, trace []string, err error) {
	var v *nanojs.VM
	...
	globals := make([]nanojs.Object, nanojs.GlobalsSize)
	...
	tr := &vmTracer{}
	c := nanojs.NewCompiler(file.InputFile, symTable, nil, modules, tr)
	err = c.Compile(file)
	trace = append(trace,
		fmt.Sprintf("\n[Compiler Trace]\n\n%s",
			strings.Join(tr.Out, "")))
	...
	v = nanojs.NewVM(bytecode, globals, maxAllocs)

	err = v.Run()
	{
		res = make(map[string]nanojs.Object)
...
func formatGlobals(globals []nanojs.Object) (formatted []string) {
...
func errorObject(v interface{}) *nanojs.Error {
	return &nanojs.Error{Value: toObject(v)}
}

func toObject(v interface{}) nanojs.Object {
	switch v := v.(type) {
	case nanojs.Object:
		return v
	case string:
...
func objectZeroCopy(o nanojs.Object) nanojs.Object {
	switch o.(type) {
	case *nanojs.Int:
		return &nanojs.Int{}
	case *nanojs.Float:
	...
	case *nanojs.Char:
		return &nanojs.Char{}
	case *nanojs.String:
		return &nanojs.String{}
	case *nanojs.Array:
		return &nanojs.Array{}
	case *nanojs.Map:
		return &nanojs.Map{}
	case *nanojs.Undefined:
		return nanojs.UndefinedValue
	case *nanojs.Error:
		return &nanojs.Error{}
	case *nanojs.Bytes:
		return &nanojs.Bytes{}
	case *nanojs.ImmutableArray:
		return &nanojs.ImmutableArray{}
