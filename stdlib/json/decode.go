...
func Decode(data []byte) (nanojs.Object, error) {
	var d decodeState
...
func (d *decodeState) value() (nanojs.Object, error) {
	switch d.opcode {
	default:
		panic(phasePanicMsg)
	case scanBeginArray:
...
func (d *decodeState) array() (nanojs.Object, error) {
	var arr []nanojs.Object
	for {
	...
	return &nanojs.Array{Value: arr}, nil
}

func (d *decodeState) object() (nanojs.Object, error) {
	m := make(map[string]nanojs.Object)
	for {
	...
	return &nanojs.Map{Value: m}, nil
}

func (d *decodeState) literal() (nanojs.Object, error) {
	...
	default: // number
		...
		return &nanojs.Float{Value: n}, nil
	}
}
